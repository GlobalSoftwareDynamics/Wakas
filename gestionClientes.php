    ...
    <body>
        ...
        <?php
            ...
            if(isset($_GET['eliminarContacto'])) {
                $eliminar = "DELETE FROM ContactoTelefono WHERE idContacto = '".$_GET['eliminarContacto']."'";
                $resutlt1 = mysql_query($eliminar);
                $result3=selectTableWhere("Contacto","idContacto","'".$_GET['eliminarContacto']."'");
                while ($fila1=mysql_fetch_array($result3)){
                    $direccion=$fila1['idDireccion'];
                    $eliminar4="DELETE FROM Contacto WHERE idContacto = '".$_GET['eliminarContacto']."'";
                    $result2=mysql_query($eliminar4);
                    $eliminar3 = "DELETE FROM Direccion WHERE idDireccion = '".$direccion."'";
                    $resutlt4 = mysql_query($eliminar3);
                }
            }
