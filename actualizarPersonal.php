    ...
    <form action="gestionOperarios.php" method="post" class="form-horizontal jumbotron col-sm-8 col-sm-offset-2">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <?php
                echo "
                     <input class='textinput-4' type='text' name='idEmp' id='idEmp' value='".$_GET['idEmpleado']."' readonly>
                ";
                ?>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-12">
                <div class="col-sm-6">
                    <input class='btn btn-default col-sm-6 col-sm-offset-3' type="submit" name="actualizaremp" value="Guardar Cambios">
                </div>
                <div class="col-sm-6">
