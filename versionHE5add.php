        ...
        <div>
            <form method="post" action="#" class="form-horizontal jumbotron col-sm-12">
                        ...
                        while($fila = mysql_fetch_array($result)){
                            ...
                            while($fila2 = mysql_fetch_array($result2)){
                                ...
                                if($fila['tipo']==="componente"){
                                    ...
                                    echo "<option>Seleccionar</option>";
                                    $result3 = selectTableWhere("Insumos",'estado','1');
                                    while ($fila3 = mysql_fetch_array($result3)) {
                                    ...
                                    echo "<option>Seleccionar</option>";
                                    $result3 = selectTable("Maquina",'estado','1');
                                    while ($fila3 = mysql_fetch_array($result3)) {
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <input type="submit" name="Volver" value="Volver" class="btn btn-default col-sm-8 col-sm-offset-2" formaction="versionHE5.php">
                        </div>
                        <div class="col-sm-6">
