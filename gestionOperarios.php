...
if(isset($_SESSION['login'])){
    ...
    if(isset($_GET['eliminarEmpleado'])) {
        ...
        if ( !empty( $error = mysql_error() ) )
        {
            ...
            echo 	"<p> <strong>Colaborador Eliminado Exitosamente</strong></p>";
            echo " </div>";
        }
    }
    if(isset($_POST['guardaremp'])){
        ...
        if ( !empty( $error = mysql_error() ) )
        {
            ...
            echo "<br>";
            echo "<div class='alert alert-success' role='alert'>";
            echo 	"<p> <strong>Colaborador Agregado Exitosamente</strong></p>";
            echo " </div>";
        }
    }
    if(isset($_POST['actualizaremp'])){
        ...
        if ( !empty( $error = mysql_error() ) )
        {
            ...
            echo "<br>";
            echo "<div class='alert alert-success' role='alert'>";
            echo 	"<p> <strong>Colaborador Actualizado Exitosamente</strong></p>";
            echo " </div>";
        }
    }
		    ...
		    <section class='container'>
		         <form class='form-horizontal col-sm-12'>
		              <div class='form-group col-sm-12'>
		                <div class='col-sm-6'>
		                    <button class='btn btn-success col-sm-6 col-sm-offset-3' formaction='agregarEmpleado.php'>Agregar Colaborador</button>
                        </div>
			            <div class='col-sm-6'>
			                <button class='btn btn-success col-sm-6 col-sm-offset-3' formaction='verActividadMuerta.php'>Ver Actividad Muerta</button>
                        </div>
			          </div>
		         </form>
            </section>
