...
if(isset($_POST['guardaremp'])){
    ...
    $agregar = "INSERT INTO empleado(idEmpleado, idTipoUsuario, nombres, apellidos, usuario, contrase�a) VALUES ('".$_POST['idEmp']."','$tipousuario','".$_POST['nombres']."','".$_POST['apellidos']."','".$_POST['usuario']."','".$_POST['pass']."')";
...
if(isset($_POST['actualizaremp'])){
    ...
    $actualziar8="UPDATE empleado SET contrase�a = '".$_POST['pass']."' WHERE idEmpleado = '".$_POST['idEmp']."'";
