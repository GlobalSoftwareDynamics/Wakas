    ...
    <body>
        ...
        <section>
            <form action="gestionCV.php" method="post">
                <div>
                    <h4>Buscar Confirmaci&oacute;n de Venta</h4>
                </div>
                <div>
                    <div>
                ...
                <div>
                    ...
                    <input class="btn btn-primary" type="submit" name="eliminarfiltro" value="Eliminar Filtro">
                </div>
            </form>
        </section>
                                        ...
                                        echo "
                                            ...
                                            <td>
                                                <form action='verCV.php' method='post'>
                                                    ...
                                                    <input type='submit' class='btn btn-link' name='detalle' value='Ver Detalle'>
                                                </form>
                                            </td>
                                            <td>
                                                <form action='verOP.php' method='post'>
                                                    <input type='hidden' name='contrato' value='".$fila['idContrato']."'>
                                                    <input type='submit' class='btn btn-link' name='detalle' value='Ver Órden de Producción'>
                                                </form>
                                            </td>
                                            </tr>
                                        ";
