...
<?php
if(isset($_POST['eliminarcv'])) {
    $eliminarcont="UPDATE ordenproduccion SET estado = '0' WHERE idContrato = '".$_POST['contrato']."'";
    $eliminarcont1=mysql_query($eliminarcont);
    $eliminarcont2="UPDATE confirmacionventa SET estado = '0' WHERE idContrato = '".$_POST['contrato']."'";
    $eliminarcont3=mysql_query($eliminarcont2);
}
?>
    ...
    <table class="table table-hover">
        ...
        if(isset($_POST['buscar'])){
            echo "
                                <tr>
                            ";
            $result=selectOrderedTableWhere2('ConfirmacionVenta','estado','1','fecha',"'".$_POST['fecha']."'",'fecha');
                        ...
                        echo "
                                            ...
                                            <td>
                                                <form action='gestionCV.php' method='post'>
                                                    <input type='hidden' name='contrato' value='".$fila['idContrato']."'>
                                                    <input type='submit' name='eliminarcv' class='btn-link' value='Eliminar'>
                                                </form>
                                            </td>
                                            </tr>
                                        ";
            ...
            $result=selectOrderedTableWhere('ConfirmacionVenta','estado','1','fecha');
            while ($fila=mysql_fetch_array($result)){
                echo "
                                    <tr>
                                        <td>".$fila['idContrato']."</td>
