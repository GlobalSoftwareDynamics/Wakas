...
if(isset($_SESSION['login'])){
    ...
    <?php
    if(isset($_POST['eliminarmaq'])) {
        $eliminar1 = "DELETE FROM RepuestosMaquina WHERE idMaquina = '".$_POST['idmaquina']."'";
        $resutlt2 = mysql_query($eliminar1);
        $eliminarcont="UPDATE maquina SET estado = '0' WHERE idMaquina = '".$_POST['idmaquina']."'";
    ...
    if(isset($_POST['guardarmaq'])){
        $agregar = "INSERT INTO maquina(idMaquina, descripcion, costoFijo, estado) VALUES ('".$_POST['idMaq']."','".$_POST['descmaq']."','".$_POST['costo']."','1')";
    ...
    <div class="container">
        <table class="table table-hover">
            ...
            <tbody>
            <?php
            $result = mysql_query("SELECT * FROM maquina WHERE estado='1' ORDER BY LENGTH(idMaquina)");
            while($fila = mysql_fetch_array($result)) {
                echo "
								<tr>
										...
										<td>
                                            <form method='post' action='verrepuestos.php'>
                                                <input type='hidden' name='idmaquina' value='".$fila['idMaquina']."'>
                                                <input type='submit' class='btn-link' name='ver' value='Ver Repuestos'>
                                            </form>
                                        </td>
										<td>
										    <form method='post'>
                                                <input type='hidden' name='idmaquina' value='".$fila['idMaquina']."'>
                                                <input type='submit' class='btn-link' name='modificar' value='Modificar' formaction='actualizarmaquina.php'>
                                            </form>
                                        </td>
                                        <td>
										    <form method='post'>
                                                <input type='hidden' name='idmaquina' value='".$fila['idMaquina']."'>
                                                <input type='submit' class='btn-link' name='eliminarmaq' value='Eliminar' formaction='gestionMaquinas.php'>
                                            </form>
                                        </td>
								</tr>
							";
