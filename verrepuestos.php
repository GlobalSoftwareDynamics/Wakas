...
<html lang="es">
	...
	<body>
        ...
        <section class="container">
            <form>
                <input type="submit" class="btn btn-default" formaction="gestionMaquinas.php" name="regresar" value="Regresar">
                <input type="submit" class="btn btn-default" formaction="gestionRepuestos.php" name="asignarrep" value="Ir a Repuestos">
            </form>
        </section>
