...
if(isset($_POST['eliminarInsumo'])) {
    $eliminar1 = "DELETE FROM InsumosProveedor WHERE idInsumo = '".$_POST['idinsumo']."'";
    $resutlt2 = mysql_query($eliminar1);
    $eliminarcont="UPDATE insumos SET estado = '0' WHERE idInsumo = '".$_POST['idinsumo']."'";
    $eliminarcont1=mysql_query($eliminarcont);
}
if(isset($_POST['guardarins'])){
    if (!empty($_POST['procedimiento'])){
        $agregar = "INSERT INTO insumos(idInsumo, idUnidadMedida, idProcedimiento, descripcion, tipoInsumo, estado ) VALUES ('".$_POST['idIns']."','".$_POST['unimed']."','".$_POST['procedimiento']."','".$_POST['descins']."','".$_POST['tipoins']."','1')";
        ...
        $agregar = "INSERT INTO insumos(idInsumo, idUnidadMedida, idProcedimiento, descripcion, tipoInsumo, estado ) VALUES ('".$_POST['idIns']."','".$_POST['unimed']."',NULL,'".$_POST['descins']."','".$_POST['tipoins']."','1')";
        $agregar1 = mysql_query($agregar);
        if ( !empty( $error = mysql_error() ) )
        {
            echo 'Mysql error '. $error ."<br />\n";
...
if(isset($_POST['actualizarins'])){
    ...
    $actualziar6="UPDATE Insumos SET tipoInsumo = '".$_POST['tipoins']."' WHERE idInsumo = '".$_POST['idIns']."'";
    $actualziar7=mysql_query($actualziar6);
    if (!empty($_POST['procedimiento'])){
        $actualziar8="UPDATE Insumos SET idProcedimiento = '".$_POST['procedimiento']."' WHERE idInsumo = '".$_POST['idIns']."'";
    ...
    echo "
                    <div class='container'>
                        <table class='table table-hover'>
                            ...
                            <tbody>
                ";
    $result = selectTableWhereLike1('Insumos','estado','1','descripcion',"'".$_POST['filtroInsumo']."'");
        ...
        echo "
                                    <td>
                                        <form method='post'>
                                            ...
                                            <input type='submit' class='btn-link' name='asignarInsumo' value='Asignar Proveedor' formaction='asignarproveedoresins.php'>
                                        </form>
                                    </td>
                                    <td>
                                        <form method='post'>
                                            <input type='hidden' name='idinsumo' value='".$fila['idInsumo']."'>
                                            <input type='submit' class='btn-link' name='modif' value='Modificar' formaction='actualizarInsumo.php'>
                                        </form>
                                    </td>
                                    <td>
                                        <form method='post'>
                                            <input type='hidden' name='idinsumo' value='".$fila['idInsumo']."'>
                                            <input type='submit' class='btn-link' name='eliminarInsumo' value='Eliminar' formaction='gestionInsumos.php'>
                                        </form>
                                    </td>
                                </tr>
                    ";
    ...
    echo "
                    <div class='container'>
                        <table class='table table-hover'>
                            ...
                            <tbody>
                ";
    $result = mysql_query("SELECT * FROM insumos WHERE estado='1' ORDER BY LENGTH(idInsumo)");
    while($fila = mysql_fetch_array($result)) {
        echo "
                                 <tr>
                                    <td>".$fila['idInsumo']."</td>
