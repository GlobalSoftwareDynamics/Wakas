...
<section class="container">
        <form method="post" action="#" class="form-horizontal jumbotron col-sm-6 col-sm-offset-3">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <div class="col-sm-6">
                        <input type="submit" value="Volver" class="btn btn-default col-sm-8 col-sm-offset-2" formaction="gestionSubprocesos.php">
                    </div>
                    <div class="col-sm-6">
                        <input type="submit" value="Asignar" class="btn btn-default col-sm-8 col-sm-offset-2" name="Asignar">
                    </div>
                </div>
            </div>
        </form>
