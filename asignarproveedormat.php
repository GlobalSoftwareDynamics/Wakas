...
<html lang="es">
	...
	<body>
        ...
        <section class="containerform">
            ...
            <form action="asignarproveedormat.php" method="post">
                <?php
                ...
                <div>
                    ...
                    <div>
                        <select id="idproveedor" name="idProv">
                            <?php
                ...
                <div>
                    <div>
                        <label for="costomat">Precio de Venta:</label>
                    </div>
                    <div>
                        <input id="costomat" type="text" name="costo">
                    </div>
                </div>
                <div>
