...
<section class="container">
    <form action="reporterendimiento.php" method="post" class="form-horizontal jumbotron col-sm-6 col-sm-offset-3">
        <div>
        ...
        <div class="form-group">
            <input class="btn btn-default col-sm-8 col-sm-offset-2 boton" type="submit" name="generarindi" value="Generar">
        </div>
        <hr>
        <div>
        ...
        <div class="form-group">
            <input class="btn btn-default col-sm-8 col-sm-offset-2 boton" type="submit" name="generarindimes" value="Generar">
        </div>
    </form>
</section>
