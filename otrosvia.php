...
<html lang="es">
    ...
    <header>
        ...
        if(isset($_GET['eliminarVia'])){
            $eliminar="DELETE FROM via WHERE idVia ='".$_GET['eliminarVia']."'";
            $eliminar1=mysql_query($eliminar);
        }
        ?>

        <section class="container col-sm-6">
            <form action="otrosvia.php" method="post" class="form-horizontal jumbotron col-sm-10 col-sm-offset-1">
                <div>
        ...
        <section class="container col-sm-6">
            <div class="container col-sm-10 col-sm-offset-1">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php
                    $result1=selectTable('Via');
                    while ($fila1=mysql_fetch_array($result1)){
                        echo "
                            <tr>
                                <td>".$fila1['descripcion']."</td>
                                <td><a href='otrosvia.php?eliminarVia=".$fila1['idVia']."'>Eliminar</a></td>
                            </tr>
                        ";
                    }
                    ?>
