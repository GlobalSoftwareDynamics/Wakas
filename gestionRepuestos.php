...
<section class="container">
    <form action="gestionRepuestos.php" method="post" class="form-horizontal jumbotron col-sm-12">
        ...
        <div class="form-group col-sm-6">
            ...
            <div class="col-sm-6">
                <input formaction="gestionRepuestos.php" class="btn btn-success col-sm-10 col-sm-offset-2 boton" type="submit" value="Eliminar Filtro">
            </div>
        </div>
    </form>
</section>
    ...
    echo "
                ...
                <section class='container'>
               	 	 <form class='form-horizontal col-sm-12'>
                            ...
                            <button class='btn btn-success col-sm-4 col-sm-offset-4' formaction='agregarRepuesto.php'>Agregar Repuesto</button>
                        </div>
                     </form>
                </section>
            ";
