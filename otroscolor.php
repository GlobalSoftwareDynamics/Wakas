...
<section class="container">
    <form action="otroscolor.php" method="post" class="form-horizontal jumbotron col-sm-8 col-sm-offset-2">
        <div>
            <h3>Agregar Color</h3>
        </div>
        <hr>
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" id="idcolor" name="idcolor" class="textinput-4">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-5">
            ...
            <div class="col-sm-7">
                <input type="text" id="desc" name="desc" class="textinput-6">
            </div>
        </div>
        <hr>
        <div class="form-group">
