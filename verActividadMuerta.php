...
<section class="container">
        <form action="verActividadMuerta.php" method="post" class="form-horizontal jumbotron col-sm-12">
            <div class="form-group col-sm-6">
                ...
                <div class="col-sm-7">
                    <input type="text" name="fecha" id="datepicker" class="ddselect-12">
                </div>
            </div>
            <div class="form-group col-sm-6">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        <input class="btn btn-success col-sm-10 col-sm-offset-2 boton" type="submit" name="eliminarfiltro" value="Eliminar Filtro">
                    </div>
                </div>
            </div>
        </form>
