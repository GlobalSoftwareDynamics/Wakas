        ...
        <section class="container">
            <form action="gestionMaquinas.php" method="post" class="form-horizontal jumbotron col-sm-8 col-sm-offset-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <?php
                            ...
                            $aux++;
                            echo "<input class='textinput-4' id='idmaquina' type='text' name= 'idMaq' value='MAQUINA".$aux."'>";
                        ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <input class="btn btn-default col-sm-6 col-sm-offset-3" type="submit" name="guardarmaq" value="Guardar M&aacute;quina">
                        </div>
                        <div class="col-sm-6">
