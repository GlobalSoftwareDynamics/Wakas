            ...
            <form action="gestionMateriales.php" method="post" class="form-horizontal jumbotron col-sm-8 col-sm-offset-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        $aux++;
                        echo "<input class='textinput-5' id='idmate' type='text' name= 'idMat' value='MATERIAL".$aux."'>";
                        ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <input class="btn btn-default col-sm-6 col-sm-offset-3" type="submit" name="guardarmat" value="Guardar Material">
                        </div>
                        <div class="col-sm-6">
