            ...
            <form action="gestionGalgas.php" method="post" class="form-horizontal jumbotron col-sm-8 col-sm-offset-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <?php
                            $clase="GAL";
                            $id=idgen($clase);
                            echo "<input class='textinput-6' id='idgalga' type='text' name= 'idGal' value='".$id."' readonly>";
                        ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-6">
                            <input class="btn btn-success col-sm-6 col-sm-offset-3" type="submit" name="guardargal" value="Agregar">
                        </div>
                    </div>
                </div>
            </form>
