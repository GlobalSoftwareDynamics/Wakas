        ...
        <section class="container">
            <form action="gestionInsumos.php" method="post" class="form-horizontal jumbotron col-sm-8 col-sm-offset-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <?php
                            ...
                            $aux++;
                            echo "<input class='textinput-4' id='idinsumo' type='text' name= 'idIns' value='INSUMO".$aux."' readonly>";
                        ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <input class="btn btn-default col-sm-6 col-sm-offset-3" type="submit" name="guardarins" value="Guardar Insumo">
                        </div>
                        <div class="col-sm-6">
