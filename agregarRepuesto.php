        ...
        <form action="gestionRepuestos.php" method="post" class="form-horizontal jumbotron col-sm-8 col-sm-offset-2">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    ...
                    $clase="REP";
                    $id=idgen($clase);
                    echo "<input class='textinput-6' type='text' name= 'idRep' id='idRep' value='".$id."' readonly>";
                    ?>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <div class="col-sm-6">
                        <input formaction="gestionRepuestos.php" class="btn btn-default col-sm-6 col-sm-offset-3" type="submit" value="Regresar">
                    </div>
                    <div class="col-sm-6">
                        <input class="btn btn-success col-sm-6 col-sm-offset-3" type="submit" name="guardarrep" value="Agregar">
                    </div>
                </div>
            </div>
        </form>
