    ...
    <section class="container">
        <form action="asignarRepuestos.php" method="post" class="form-horizontal jumbotron col-sm-8 col-sm-offset-2">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <div class="col-sm-4">
                        <input class="btn btn-default col-sm-10 col-sm-offset-2" type="submit" name="asignar" value="Asignar M&aacute;quina">
                    </div>
                    <div class="col-sm-4">
                        <input formaction="gestionMaquinas.php" class="btn btn-default col-sm-10 col-sm-offset-2" type="submit" value="Ir a M&aacute;quinas">
                    </div>
                    <div class="col-sm-4">
