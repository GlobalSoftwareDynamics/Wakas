...
if(!empty($_POST["producto"])) {
    ...
    $talla ="SELECT DISTINCT idTalla FROM TallaMedida WHERE idProducto = '".$_POST["producto"]."' AND valor>0";
    ...
    foreach ($tallas1 as $value1) {
        ...
        foreach ($tallas2 as $value2) {
            if ($value1 == $value2){
                $encontrado=true;
		        echo "<td><input type='text' class='textinput-12 form-control' name='".$value2."'></td>";
            }
        }
        if ($encontrado == false){
